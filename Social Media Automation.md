...
- when a plan is active, the UI disables the monthly button (Monthly active disables monthly, Yearly active disables monthly) so users do not accidentally re-purchase the monthly plan while already active
